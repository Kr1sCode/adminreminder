...
const DEMO_SETTINGS = {
  ...
  email_provider: "smtp",
  email_from: "Monitoring AdminReminder <monitoring@demo-firma.pl>",
  ...
  ad_start_tls: "false",
  ad_bind_dn: "CN=svc-adminreminder,OU=Konta Serwisowe,DC=demo-firma,DC=local",
  ...
  webhook_url: "https://hooks.demo-firma.pl/adminreminder",
